...
class AccountPayment(models.Model):
    ...
    analytic_acc_id = fields.Many2one('account.analytic.account','Analytic_account')
        ...
        if invoice_defaults and len(invoice_defaults) == 1:
            ...
            if invoice['refund_invoice_id']:
                ...
                if refund_origin_invoice.sale_order_id:
                    ...
                    rec['sale_team_id'] = refund_origin_invoice.sale_order_id.team_id.id
        ...
        for rec in self:
            ...
            for inv in rec.invoice_ids:
                if inv.refund_invoice_id.sale_order_id:
                    rec.write({'sale_id': inv.refund_invoice_id.sale_order_id.id, 'sale_team_id': inv.refund_invoice_id.sale_order_id.team_id.id})
